...
//        }
    ...
    private void initFragment() {
        ...
        mFragments.add(ProjectFragment.newInstance(latitude,longitude));
    }
...
//                        ToastUtils.showShort("第二个");
                    ...
                    case R.id.icon3:
                        ...
                        break;
                    case R.id.icon4:
//                        StatusBarUtil.setColor(getResources().getColor(R.color.colorPrimary,));
//                        ToastUtils.showShort("第四个"R);
